...
def main():
    ...
    if current_user:
            ...
            if high_preference == "gender & religion":
                user_prompt = f"here is my datas {details}.and prioritize matches who are {date_gender}. and FOLLOW {date_religion} give in ordered list, full data view and don't give me the sample datas"


            elif high_preference == "gender & job":
                user_prompt =  f"here is my datas {details}.and prioritize matches who are {date_gender}. and has job as the {date_job} give in ordered list, full data view and don't give me the sample datas"

...
def main():
    ...
    if current_user:
            ...
            if high_preference == "gender & religion":
                ...
                user_prompt =  f"here is my datas {details}.and prioritize matches who are {date_gender} and has job as the {date_job}.give the most suitable filtered profiles. dont give me the sample datas"
